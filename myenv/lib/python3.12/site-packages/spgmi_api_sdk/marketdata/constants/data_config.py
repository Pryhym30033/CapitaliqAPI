from spgmi_api_sdk.marketdata.constants.mnemonics_constants import MnemonicConstants
from spgmi_api_sdk.marketdata.constants.functions_constants import FunctionConstants
class DataConfig:
