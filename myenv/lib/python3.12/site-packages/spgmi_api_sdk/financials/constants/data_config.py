from spgmi_api_sdk.financials.constants.mnemonics_constants import MnemonicConstants
from spgmi_api_sdk.financials.constants.functions_constants import FunctionConstants
...
class DataConfig:
    ...
    def get_financials_function(self):
        return FunctionConstants._financials_function

    def get_financial_mnemonics(self):
        return MnemonicConstants._financial_mnemonics

    def get_financials_data_mnemonics_caption(self):
        return MnemonicConstants._financials_data_mnemonics_caption
